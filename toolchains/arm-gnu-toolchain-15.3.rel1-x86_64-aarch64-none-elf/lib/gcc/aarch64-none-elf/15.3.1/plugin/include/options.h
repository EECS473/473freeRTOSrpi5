...
#endif
#ifdef GENERATOR_FILE
extern enum aarch64_cpu selected_tune;
#else
  enum aarch64_cpu x_selected_tune;
...
#endif
#ifdef GENERATOR_FILE
extern int warn_experimental_fmv;
#else
  int x_warn_experimental_fmv;
#define warn_experimental_fmv global_options.x_warn_experimental_fmv
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT__param_file_cache_files_ = 115,        /* --param=file-cache-files= */
  OPT__param_file_cache_lines_ = 116,        /* --param=file-cache-lines= */
  OPT__param_fsm_scale_path_stmts_ = 117,    /* --param=fsm-scale-path-stmts= */
  OPT__param_fully_pipelined_fma_ = 118,     /* --param=fully-pipelined-fma= */
  OPT__param_gcse_after_reload_critical_fraction_ = 119,/* --param=gcse-after-reload-critical-fraction= */
  OPT__param_gcse_after_reload_partial_fraction_ = 120,/* --param=gcse-after-reload-partial-fraction= */
  OPT__param_gcse_cost_distance_ratio_ = 121,/* --param=gcse-cost-distance-ratio= */
  OPT__param_gcse_unrestricted_cost_ = 122,  /* --param=gcse-unrestricted-cost= */
  OPT__param_ggc_min_expand_ = 123,          /* --param=ggc-min-expand= */
  OPT__param_ggc_min_heapsize_ = 124,        /* --param=ggc-min-heapsize= */
  OPT__param_gimple_fe_computed_hot_bb_threshold_ = 125,/* --param=gimple-fe-computed-hot-bb-threshold= */
  OPT__param_graphite_allow_codegen_errors_ = 126,/* --param=graphite-allow-codegen-errors= */
  OPT__param_graphite_max_arrays_per_scop_ = 127,/* --param=graphite-max-arrays-per-scop= */
  OPT__param_graphite_max_nb_scop_params_ = 128,/* --param=graphite-max-nb-scop-params= */
  OPT__param_hardcfr_max_blocks_ = 129,      /* --param=hardcfr-max-blocks= */
  OPT__param_hardcfr_max_inline_blocks_ = 130,/* --param=hardcfr-max-inline-blocks= */
  OPT__param_hash_table_verification_limit_ = 131,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 132,   /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 133,/* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 134,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hwasan_instrument_allocas_ = 135,/* --param=hwasan-instrument-allocas= */
  OPT__param_hwasan_instrument_mem_intrinsics_ = 136,/* --param=hwasan-instrument-mem-intrinsics= */
  OPT__param_hwasan_instrument_reads_ = 137, /* --param=hwasan-instrument-reads= */
  OPT__param_hwasan_instrument_stack_ = 138, /* --param=hwasan-instrument-stack= */
  OPT__param_hwasan_instrument_writes_ = 139,/* --param=hwasan-instrument-writes= */
  OPT__param_hwasan_random_frame_tag_ = 140, /* --param=hwasan-random-frame-tag= */
  OPT__param_inline_heuristics_hint_percent_ = 141,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 142,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 143,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 144,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 145,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_large_unit_insns_ = 146, /* --param=ipa-cp-large-unit-insns= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 147,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 148,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 149,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_profile_count_base_ = 150,/* --param=ipa-cp-profile-count-base= */
  OPT__param_ipa_cp_recursion_penalty_ = 151,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 152,/* --param=ipa-cp-recursive-freq-factor= */
  OPT__param_ipa_cp_single_call_penalty_ = 153,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 154,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 155,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_jump_function_lookups_ = 156,/* --param=ipa-jump-function-lookups= */
  OPT__param_ipa_max_aa_steps_ = 157,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 158,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_loop_predicates_ = 159, /* --param=ipa-max-loop-predicates= */
  OPT__param_ipa_max_param_expr_ops_ = 160,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 161,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_deref_prob_threshold_ = 162,/* --param=ipa-sra-deref-prob-threshold= */
  OPT__param_ipa_sra_max_replacements_ = 163,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 164,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipa_sra_ptrwrap_growth_factor_ = 165,/* --param=ipa-sra-ptrwrap-growth-factor= */
  OPT__param_ira_consider_dup_in_all_alts_ = 166,/* --param=ira-consider-dup-in-all-alts= */
  OPT__param_ira_loop_reserved_regs_ = 167,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 168,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 169,       /* --param=ira-max-loops-num= */
  OPT__param_ira_simple_lra_insn_threshold_ = 170,/* --param=ira-simple-lra-insn-threshold= */
  OPT__param_iv_always_prune_cand_set_bound_ = 171,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 172,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 173,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 174,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 175,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 176,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 177,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 178,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 179,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 180,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 181,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 182,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 183,        /* --param=large-unit-insns= */
  OPT__param_lazy_modules_ = 184,            /* --param=lazy-modules= */
  OPT__param_lim_expensive_ = 185,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 186,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 187,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 188,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 189,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 190,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 191,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 192,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 193,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 194,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 195,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_locality_partition_ = 196,/* --param=lto-max-locality-partition= */
  OPT__param_lto_max_partition_ = 197,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 198,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 199,       /* --param=lto-min-partition= */
  OPT__param_lto_partition_locality_cloning_ = 200,/* --param=lto-partition-locality-cloning= */
  OPT__param_lto_partition_locality_frequency_cutoff_ = 201,/* --param=lto-partition-locality-frequency-cutoff= */
  OPT__param_lto_partition_locality_size_cutoff_ = 202,/* --param=lto-partition-locality-size-cutoff= */
  OPT__param_lto_partitions_ = 203,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 204,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 205,       /* --param=max-combine-insns= */
  OPT__param_max_combine_search_insns_ = 206,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 207,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 208,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 209,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 210,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 211,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 212,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 213,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 214,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 215,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 216,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 217,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 218,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 219,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 220,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 221,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 222,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 223,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 224,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 225,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 226,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 227,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 228,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 229,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 230,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 231,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 232, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 233,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 234,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 235,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 236,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 237,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 238,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 239, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 240,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 241,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 242,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 243,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 244,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 245,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 246,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 247,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 248,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 249, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 250,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 251,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 252,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 253,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 254, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 255,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 256,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 257,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 258,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 259,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 260,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 261, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 262,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 263,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 264,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 265,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 266,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 267,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 268,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 269,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 270,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 271,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 272,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 273,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 274,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 275,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 276,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 277,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 278,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 279, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 280,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 281,       /* --param=max-vartrack-size= */
  OPT__param_min_crossjump_insns_ = 282,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 283,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 284,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 285,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 286,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 287,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 288,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 289,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 290,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 291,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 292,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 293,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 294,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 295,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 296,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 297,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 298,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 299,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 300,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 301, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 302,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 303,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 304,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 305,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 306,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 307,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 308,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 309, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 310,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 311,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 312,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 313,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 314,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 315,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 316,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 317,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 318,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 319,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 320, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 321,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 322,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 323,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 324,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 325,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 326,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 327, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 328,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 329,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 330,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 331,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 332,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 333,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 334,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 335,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 336,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 337,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 338,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 339,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_forwarding_max_distance_ = 340,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 341,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 342,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 343,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_switch_lower_slow_alg_max_cases_ = 344,/* --param=switch-lower-slow-alg-max-cases= */
  OPT__param_threader_debug_ = 345,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 346,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 347,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 348, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 349,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 350,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 351,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 352, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 353,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 354,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 355,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 356,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 357,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 358,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 359,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 360,   /* --param=uninit-max-prune-work= */
  OPT__param_uninlined_function_insns_ = 361,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 362, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 363,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 364,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 365,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 366,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 367,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 368,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 369,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 370,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_force_slp_ = 371,          /* --param=vect-force-slp= */
  OPT__param_vect_induction_float_ = 372,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 373,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 374,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 375,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 376,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 377,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 378,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp_block_limit_ = 379,         /* --param=vrp-block-limit= */
  OPT__param_vrp_sparse_threshold_ = 380,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 381,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 382,    /* --param=vrp-vector-threshold= */
  /* OPT__pass_exit_codes = 383, */          /* --pass-exit-codes */
  /* OPT__pedantic = 384, */                 /* --pedantic */
  /* OPT__pedantic_errors = 385, */          /* --pedantic-errors */
  /* OPT__pie = 386, */                      /* --pie */
  /* OPT__pipe = 387, */                     /* --pipe */
  /* OPT__prefix = 388, */                   /* --prefix */
  /* OPT__prefix_ = 389, */                  /* --prefix= */
  /* OPT__preprocess = 390, */               /* --preprocess */
  ...
  OPT_Wa_ = 473,                             /* -Wa, */
  OPT_Wabi = 474,                            /* -Wabi */
  OPT_Wabi_tag = 475,                        /* -Wabi-tag */
  OPT_Wabi_ = 476,                           /* -Wabi= */
  OPT_Wabsolute_value = 477,                 /* -Wabsolute-value */
  OPT_Waddress = 478,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 479,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 480,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 481,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 482,                       /* -Waliasing */
  OPT_Walign_commons = 483,                  /* -Walign-commons */
  /* OPT_Waligned_new = 484, */              /* -Waligned-new */
  OPT_Waligned_new_ = 485,                   /* -Waligned-new= */
  OPT_Wall = 486,                            /* -Wall */
  OPT_Walloc_size = 487,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 488,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 489,                     /* -Walloc-zero */
  OPT_Walloca = 490,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 491,            /* -Walloca-larger-than= */
  OPT_Wampersand = 492,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 493,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 494,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 495,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 496,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 497,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 498,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 499,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 500,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 501,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 502,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 503,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 504,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 505,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 506,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 507,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 508,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 509,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 510,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 511,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 512,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 513,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 514,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 515,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 516,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 517,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 518,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 519,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 520,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 521,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 522,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 523,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 524,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 525,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 526,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 527,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 528,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 529,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 530,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 531,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 532,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 533,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 534,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 535,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 536,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 537,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 538,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 539,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 540,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 541,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 542,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 543,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 544,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 545,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 546, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 547,                  /* -Warray-bounds= */
  OPT_Warray_compare = 548,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 549, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 550,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 551,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 552,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 553, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 554,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 555,              /* -Wattribute-warning */
  OPT_Wattributes = 556,                     /* -Wattributes */
  OPT_Wattributes_ = 557,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 558,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 559, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 560,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 561,                   /* -Wbool-compare */
  OPT_Wbool_operation = 562,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 563,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 564,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 565,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 566, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 567,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 568,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 569,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 570,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 571,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 572,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 573, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 574,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 575,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 576,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 577,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 578, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 579,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 580,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 581, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 582,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 583,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 584,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 585,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 586,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 587,                      /* -Wcase-enum */
  OPT_Wcast_align = 588,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 589,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 590,             /* -Wcast-function-type */
  OPT_Wcast_qual = 591,                      /* -Wcast-qual */
  OPT_Wcast_result = 592,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 593,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 594, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 595,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 596,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 597,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 598,           /* -Wcharacter-truncation */
  OPT_Wchkp = 599,                           /* -Wchkp */
  OPT_Wclass_conversion = 600,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 601,                /* -Wclass-memaccess */
  OPT_Wclobbered = 602,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 603,                /* -Wcomma-subscript */
  OPT_Wcomment = 604,                        /* -Wcomment */
  /* OPT_Wcomments = 605, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 606, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 607,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 608,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 609,        /* -Wconditionally-supported */
  OPT_Wconversion = 610,                     /* -Wconversion */
  OPT_Wconversion_extra = 611,               /* -Wconversion-extra */
  OPT_Wconversion_null = 612,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 613,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 614,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 615,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 616,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 617,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 618,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 619,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 620,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 621, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 622,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 623,             /* -Wdangling-reference */
  OPT_Wdate_time = 624,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 625,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 626,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 627,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 628,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 629,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 630,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 631,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 632,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 633,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 634,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 635,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 636,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 637,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_variadic_comma_omission = 638,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 639,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 640,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 641,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 642,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 643,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 644,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 645,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 646,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 647,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 648,                /* -Wduplicated-cond */
  OPT_Weffc__ = 649,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 650,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 651,                     /* -Wempty-body */
  OPT_Wendif_labels = 652,                   /* -Wendif-labels */
  OPT_Wenum_compare = 653,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 654,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 655,              /* -Wenum-int-mismatch */
  OPT_Werror = 656,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 657, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 658,                         /* -Werror= */
  OPT_Wexceptions = 659,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 660,           /* -Wexpansion-to-defined */
  OPT_Wexperimental_fmv_target = 661,        /* -Wexperimental-fmv-target */
  OPT_Wexternal_argument_mismatch = 662,     /* -Wexternal-argument-mismatch */
  OPT_Wextra = 663,                          /* -Wextra */
  OPT_Wextra_semi = 664,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 665,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 666,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 667,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 668,                    /* -Wfloat-equal */
  /* OPT_Wformat = 669, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 670,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 671,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 672,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 673,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 674, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 675,               /* -Wformat-overflow= */
  OPT_Wformat_security = 676,                /* -Wformat-security */
  OPT_Wformat_signedness = 677,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 678, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 679,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 680,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 681,             /* -Wformat-zero-length */
  OPT_Wformat_ = 682,                        /* -Wformat= */
  OPT_Wframe_address = 683,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 684,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 685,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 686,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 687,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 688,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 689,                  /* -Wglobal-module */
  OPT_Whardened = 690,                       /* -Whardened */
  OPT_Wheader_guard = 691,                   /* -Wheader-guard */
  /* OPT_Whsa = 692, */                      /* -Whsa */
  OPT_Wif_not_aligned = 693,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 694,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 695,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 696,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 697, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 698,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 699,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 700,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 701,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 702,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 703, */                   /* -Wimport */
  OPT_Winaccessible_base = 704,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 705,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 706,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 707,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 708,             /* -Winit-list-lifetime */
  OPT_Winit_self = 709,                      /* -Winit-self */
  OPT_Winline = 710,                         /* -Winline */
  OPT_Wint_conversion = 711,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 712,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 713,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 714,               /* -Winteger-division */
  OPT_Winterference_size = 715,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 716,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 717,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 718,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 719,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 720,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 721,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 722,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 723,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 724,               /* -Wjump-misses-init */
  OPT_Wl_ = 725,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 726, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 727,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 728,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 729,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 730,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 731,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 732,                     /* -Wlogical-op */
  OPT_Wlong_long = 733,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 734,              /* -Wlto-type-mismatch */
  OPT_Wmain = 735,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 736,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 737,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 738,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 739,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 740,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 741,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 742,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 743,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 744,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 745,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 746,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 747,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 748,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 749, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 750,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 751, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 752,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 753,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 754,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 755,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 756,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 757,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 758,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 759,                        /* -Wmudflap */
  OPT_Wmultichar = 760,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 761,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 762,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 763,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 764,                     /* -Wnamespaces */
  OPT_Wnarrowing = 765,                      /* -Wnarrowing */
  OPT_Wnested_externs = 766,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 767, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 768, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 769, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 770, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 771, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 772, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 773,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 774,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 775,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 776,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 777,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 778,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 779, */               /* -Wnormalized */
  OPT_Wnormalized_ = 780,                    /* -Wnormalized= */
  OPT_Wnrvo = 781,                           /* -Wnrvo */
  OPT_Wnull_dereference = 782,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 783,                /* -Wobjc-root-class */
  OPT_Wodr = 784,                            /* -Wodr */
  OPT_Wold_style_cast = 785,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 786,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 787,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 788,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 789,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 790,                    /* -Wopenmp-simd */
  OPT_Woverflow = 791,                       /* -Woverflow */
  OPT_Woverlength_strings = 792,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 793, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 794,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 795,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 796,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 797,            /* -Woverwrite-recursive */
  OPT_Wp_ = 798,                             /* -Wp, */
  OPT_Wpacked = 799,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 800,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 801,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 802,                         /* -Wpadded */
  OPT_Wparentheses = 803,                    /* -Wparentheses */
  OPT_Wpedantic = 804,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 805,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 806,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 807,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 808, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 809,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 810,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 811,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 812,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 813,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 814,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 815,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 816,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 817,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 818,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 819,                       /* -Wprotocol */
  OPT_Wpsabi = 820,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 821,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 822,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 823,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 824,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 825,                /* -Wredundant-decls */
  OPT_Wredundant_move = 826,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 827,                 /* -Wredundant-tags */
  OPT_Wregister = 828,                       /* -Wregister */
  OPT_Wreorder = 829,                        /* -Wreorder */
  OPT_Wrestrict = 830,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 831,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 832,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 833,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 834,           /* -Wscalar-storage-order */
  OPT_Wselector = 835,                       /* -Wselector */
  OPT_Wself_move = 836,                      /* -Wself-move */
  OPT_Wsequence_point = 837,                 /* -Wsequence-point */
  OPT_Wshadow = 838,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 839, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 840,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 841, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 842,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 843, */            /* -Wshadow=global */
  OPT_Wshadow_local = 844,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 845,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 846,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 847,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 848, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 849,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 850,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 851,                /* -Wsign-conversion */
  OPT_Wsign_promo = 852,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 853,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 854,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 855,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 856,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 857,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 858,                    /* -Wspeculative */
  OPT_Wstack_protector = 859,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 860,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 861,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 862,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 863,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 864,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 865,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 866,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 867,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 868,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 869,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 870, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 871,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 872,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 873,            /* -Wstringop-truncation */
  OPT_Wstyle = 874,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 875,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 876,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 877,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 878,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 879,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 880,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 881,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 882,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 883,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 884,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 885,               /* -Wsuggest-override */
  OPT_Wsurprising = 886,                     /* -Wsurprising */
  OPT_Wswitch = 887,                         /* -Wswitch */
  OPT_Wswitch_bool = 888,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 889,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 890,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 891,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 892,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 893,                      /* -Wsync-nand */
  OPT_Wsynth = 894,                          /* -Wsynth */
  OPT_Wsystem_headers = 895,                 /* -Wsystem-headers */
  OPT_Wtabs = 896,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 897,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 898,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 899,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 900,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 901,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 902,                      /* -Wtemplates */
  OPT_Wterminate = 903,                      /* -Wterminate */
  OPT_Wtraditional = 904,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 905,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 906, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 907,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 908,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 909,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 910,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 911,                           /* -Wtsan */
  OPT_Wtype_limits = 912,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 913,            /* -Wundeclared-selector */
  OPT_Wundef = 914,                          /* -Wundef */
  OPT_Wundefined_do_loop = 915,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 916,                      /* -Wunderflow */
  OPT_Wunicode = 917,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 918,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 919,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 920,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 921,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 922, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 923, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 924,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 925,/* -Wunterminated-string-initialization */
  OPT_Wunused = 926,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 927,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 928,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 929, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 930,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 931,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 932,                /* -Wunused-function */
  OPT_Wunused_label = 933,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 934,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 935,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 936,               /* -Wunused-parameter */
  OPT_Wunused_result = 937,                  /* -Wunused-result */
  OPT_Wunused_value = 938,                   /* -Wunused-value */
  OPT_Wunused_variable = 939,                /* -Wunused-variable */
  OPT_Wuse_after_free = 940,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 941,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 942,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 943,                   /* -Wuseless-cast */
  OPT_Wvarargs = 944,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 945,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 946,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 947,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 948,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 949,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 950,            /* -Wvirtual-move-assign */
  OPT_Wvla = 951,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 952,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 953,                  /* -Wvla-parameter */
  OPT_Wvolatile = 954,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 955,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 956,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 957,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 958,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 959,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 960,                       /* -Wzerotrip */
  OPT_X = 961,                               /* -X */
  OPT_Xassembler = 962,                      /* -Xassembler */
  OPT_Xf = 963,                              /* -Xf */
  OPT_Xlinker = 964,                         /* -Xlinker */
  OPT_Xpreprocessor = 965,                   /* -Xpreprocessor */
  OPT_Z = 966,                               /* -Z */
  OPT_ansi = 967,                            /* -ansi */
  OPT_aux_info = 968,                        /* -aux-info */
  /* OPT_aux_info_ = 969, */                 /* -aux-info= */
  OPT_c = 970,                               /* -c */
  OPT_callgraph = 971,                       /* -callgraph */
  OPT_copyext = 972,                         /* -copyext */
  OPT_coverage = 973,                        /* -coverage */
  OPT_cpp = 974,                             /* -cpp */
  OPT_cpp_ = 975,                            /* -cpp= */
  OPT_d = 976,                               /* -d */
  OPT_debuglib_ = 977,                       /* -debuglib= */
  OPT_defaultlib_ = 978,                     /* -defaultlib= */
  OPT_defined_only = 979,                    /* -defined-only */
  OPT_demangle = 980,                        /* -demangle */
  OPT_dialect = 981,                         /* -dialect */
  OPT_dstartfiles = 982,                     /* -dstartfiles */
  OPT_dump_body_ = 983,                      /* -dump-body= */
  OPT_dump_level_ = 984,                     /* -dump-level= */
  OPT_dumpbase = 985,                        /* -dumpbase */
  OPT_dumpbase_ext = 986,                    /* -dumpbase-ext */
  OPT_dumpdir = 987,                         /* -dumpdir */
  OPT_dumpfullversion = 988,                 /* -dumpfullversion */
  OPT_dumpmachine = 989,                     /* -dumpmachine */
  OPT_dumpspecs = 990,                       /* -dumpspecs */
  OPT_dumpversion = 991,                     /* -dumpversion */
  OPT_e = 992,                               /* -e */
  OPT_export_dynamic = 993,                  /* -export-dynamic */
  OPT_fPIC = 994,                            /* -fPIC */
  OPT_fPIE = 995,                            /* -fPIE */
  OPT_fRTS_ = 996,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 997,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 998,                   /* -fabi-version= */
  OPT_faccess_control = 999,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 1000,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1001,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1002, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1003,                 /* -falign-commons */
  OPT_falign_functions = 1004,               /* -falign-functions */
  OPT_falign_functions_ = 1005,              /* -falign-functions= */
  OPT_falign_jumps = 1006,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1007,                  /* -falign-jumps= */
  OPT_falign_labels = 1008,                  /* -falign-labels */
  OPT_falign_labels_ = 1009,                 /* -falign-labels= */
  OPT_falign_loops = 1010,                   /* -falign-loops */
  OPT_falign_loops_ = 1011,                  /* -falign-loops= */
  /* OPT_faligned_new = 1012, */             /* -faligned-new */
  OPT_faligned_new_ = 1013,                  /* -faligned-new= */
  OPT_fall_instantiations = 1014,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1015,                /* -fall-intrinsics */
  OPT_fall_virtual = 1016,                   /* -fall-virtual */
  OPT_fallocation_dce = 1017,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1018,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1019,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1020,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1021, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1022,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1023,        /* -falt-external-templates */
  OPT_fanalyzer = 1024,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1025,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1026,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1027,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1028,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1029,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1030, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1031,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1032,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1033,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1034,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1035,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1036,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1037,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1038,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1039,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1040, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1041, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1042, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1043, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1044,           /* -fasan-shadow-offset= */
  OPT_fasm = 1045,                           /* -fasm */
  OPT_fassert = 1046,                        /* -fassert */
  OPT_fassociative_math = 1047,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1048,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1049,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1050,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1051,                     /* -fauto-init */
  OPT_fauto_profile = 1052,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1053,                 /* -fauto-profile= */
  OPT_fautomatic = 1054,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1055,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1056,                     /* -fbackslash */
  OPT_fbacktrace = 1057,                     /* -fbacktrace */
  OPT_fbit_tests = 1058,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1059,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1060,                        /* -fbounds */
  OPT_fbounds_check = 1061,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1062,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1063,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1064,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1065, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1066, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1067, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1068,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1069,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1070,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1071,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1072,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1073,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1074,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1075,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1076,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1077,                    /* -fcall-used- */
  OPT_fcaller_saves = 1078,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1079,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1080,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1081,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1082,      /* -fcanonical-system-headers */
  OPT_fcase = 1083,                          /* -fcase */
  /* OPT_fcf_protection = 1084, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1085,                /* -fcf-protection= */
  OPT_fchar8_t = 1086,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1087,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1088, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1089,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1090,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1091,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1092, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1093, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1094, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1095, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1096, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1097, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1098,                  /* -fcheckaction= */
  OPT_fchecking = 1099,                      /* -fchecking */
  OPT_fchecking_ = 1100,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1101,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1102,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1103,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1104,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1105,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1106,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1107,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1108,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1109,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1110,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1111,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1112,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1113,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1114,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1115,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1116,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1117,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1118,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1119, */                /* -fcilkplus */
  OPT_fcoarray_ = 1120,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1121,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1122,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1123,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1124,                        /* -fcommon */
  OPT_fcompare_debug = 1125,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1126,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1127,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1128,                  /* -fcompare-elim */
  OPT_fconcepts = 1129,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1130,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1131,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1132,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1133,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1134, */          /* -fconserve-space */
  OPT_fconserve_stack = 1135,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1136,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1137,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1138,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1139,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1140,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1141,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1142,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1143,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1144,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1145,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1146,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1147,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1148, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1149,                     /* -fcontracts */
  OPT_fconvert_ = 1150,                      /* -fconvert= */
  OPT_fcoroutines = 1151,                    /* -fcoroutines */
  OPT_fcpp = 1152,                           /* -fcpp */
  OPT_fcpp_begin = 1153,                     /* -fcpp-begin */
  OPT_fcpp_end = 1154,                       /* -fcpp-end */
  OPT_fcprop_registers = 1155,               /* -fcprop-registers */
  OPT_fcray_pointer = 1156,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1157,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1158,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1159, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1160,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1161,              /* -fcx-limited-range */
  OPT_fd = 1162,                             /* -fd */
  OPT_fd_lines_as_code = 1163,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1164,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1165,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1166,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1167,                      /* -fdbg-cnt= */
  OPT_fdce = 1168,                           /* -fdce */
  OPT_fdebug = 1169,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1170,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1171,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1172,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1173,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1174,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1175,           /* -fdebug-types-section */
  OPT_fdebug_ = 1176,                        /* -fdebug= */
  OPT_fdec = 1177,                           /* -fdec */
  OPT_fdec_blank_format_item = 1178,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1179,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1180,           /* -fdec-format-defaults */
  OPT_fdec_include = 1181,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1182,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1183,                      /* -fdec-math */
  OPT_fdec_static = 1184,                    /* -fdec-static */
  OPT_fdec_structure = 1185,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1186,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1187, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1188,                          /* -fdef= */
  OPT_fdefault_double_8 = 1189,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1190, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1191,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1192,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1193,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1194,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1195,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1196,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1197,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1198,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1199,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1200,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1201,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1202,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1203,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1204,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1205,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1206,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1207,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1208, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1209,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1210,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1211,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1212,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1213,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1214,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1215,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1216,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1217,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1218,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1219,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1220,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1221,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1222,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1223,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1224,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1225,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1226, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1227,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1228,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1229,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1230,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1231,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1232, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1233,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1234,               /* -fdirectives-only */
  OPT_fdisable_ = 1235,                      /* -fdisable- */
  OPT_fdoc = 1236,                           /* -fdoc */
  OPT_fdoc_dir_ = 1237,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1238,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1239,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1240,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1241,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1242,                      /* -fdruntime */
  OPT_fdse = 1243,                           /* -fdse */
  OPT_fdump_ = 1244,                         /* -fdump- */
  OPT_fdump_ada_spec = 1245,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1246,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1247,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1248,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1249,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1250,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1251,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1252,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1253,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1254,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1255,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1256,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1257,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1258,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1259,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1260,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1261,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1262,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1263, */               /* -fdump-core */
  OPT_fdump_d_original = 1264,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1265,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1266,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1267,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1268,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1269,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1270,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1271,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1272,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1273, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1274,                   /* -fdump-passes */
  OPT_fdump_scos = 1275,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1276,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1277,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1278,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1279,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1280,                /* -fearly-inlining */
  OPT_felide_constructors = 1281,            /* -felide-constructors */
  OPT_felide_type = 1282,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1283, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1284,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1285,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1286,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1287,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1288,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1289,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1290,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1291,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1292,                /* -fenum-int-equiv */
  OPT_fexceptions = 1293,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1294,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1295,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1296,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1297,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1298,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1299,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1300,               /* -fextended-opaque */
  OPT_fextern_std_ = 1301,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1302,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1303,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1304,            /* -fexternal-templates */
  OPT_ff2c = 1305,                           /* -ff2c */
  OPT_ffast_math = 1306,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1307,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1308,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1309,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1310,              /* -ffinite-math-only */
  OPT_ffixed_ = 1311,                        /* -ffixed- */
  OPT_ffixed_form = 1312,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1313,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1314,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1315,                    /* -fflex-debug */
  OPT_ffloat_store = 1316,                   /* -ffloat-store */
  OPT_ffloatvalue = 1317,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1318,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1319,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1320,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1321, */              /* -fforce-addr */
  OPT_fforward_propagate = 1322,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1323,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1324,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1325,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1326,                     /* -ffpe-trap= */
  OPT_ffree_form = 1327,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1328,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1329,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1330,                  /* -ffreestanding */
  OPT_ffriend_injection = 1331,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1332,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1333,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1334,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1335,             /* -ffunction-sections */
  OPT_fgcse = 1336,                          /* -fgcse */
  OPT_fgcse_after_reload = 1337,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1338,                      /* -fgcse-las */
  OPT_fgcse_lm = 1339,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1340,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1341,              /* -fgen-module-list= */
  OPT_fgimple = 1342,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1343,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1344,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1345,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1346,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1347,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1348,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1349,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1350,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1351,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1352,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1353,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1354,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1355,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1356,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1357,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1358,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1359,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1360,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1361,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1362,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1363,                      /* -fgraphite */
  OPT_fgraphite_identity = 1364,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1365,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1366,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1367, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1368,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1369, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1370, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1371,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1372,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1373,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1374,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1375,                      /* -fhardened */
  /* OPT_fhelp = 1376, */                    /* -fhelp */
  /* OPT_fhelp_ = 1377, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1378,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1379,                     /* -fhonor-std */
  OPT_fhosted = 1380,                        /* -fhosted */
  OPT_fhuge_objects = 1381,                  /* -fhuge-objects */
  OPT_fident = 1382,                         /* -fident */
  OPT_fif_conversion = 1383,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1384,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1385,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1386,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1387,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1388,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1389,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1390,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1391,            /* -fimplicit-templates */
  OPT_finclude_imports = 1392,               /* -finclude-imports */
  OPT_findex = 1393,                         /* -findex */
  OPT_findicator_column = 1394,              /* -findicator-column */
  OPT_findirect_inlining = 1395,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1396,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1397,               /* -finit-character= */
  OPT_finit_derived = 1398,                  /* -finit-derived */
  OPT_finit_integer_ = 1399,                 /* -finit-integer= */
  OPT_finit_local_zero = 1400,               /* -finit-local-zero */
  OPT_finit_logical_ = 1401,                 /* -finit-logical= */
  OPT_finit_real_ = 1402,                    /* -finit-real= */
  OPT_finline = 1403,                        /* -finline */
  OPT_finline_arg_packing = 1404,            /* -finline-arg-packing */
  OPT_finline_atomics = 1405,                /* -finline-atomics */
  OPT_finline_functions = 1406,              /* -finline-functions */
  OPT_finline_functions_called_once = 1407,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1408,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1409,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1410, */           /* -finline-limit- */
  OPT_finline_limit_ = 1411,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1412,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1413,        /* -finline-small-functions */
  OPT_finline_stringops = 1414,              /* -finline-stringops */
  OPT_finline_stringops_ = 1415,             /* -finline-stringops= */
  OPT_finput_charset_ = 1416,                /* -finput-charset= */
  OPT_finstrument_functions = 1417,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1418,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1419,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1420,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1421,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1422,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1423,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1424,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1425,                    /* -finvariants */
  OPT_fipa_bit_cp = 1426,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1427,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1428, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1429,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1430,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1431,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1432,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1433, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1434,                    /* -fipa-modref */
  OPT_fipa_profile = 1435,                   /* -fipa-profile */
  OPT_fipa_pta = 1436,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1437,                /* -fipa-pure-const */
  OPT_fipa_ra = 1438,                        /* -fipa-ra */
  OPT_fipa_reference = 1439,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1440,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1441,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1442,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1443,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1444,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1445, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1446,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1447,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1448,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1449,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1450,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1451,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1452,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1453,                  /* -fira-verbose= */
  OPT_fiso = 1454,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1455,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1456,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1457,              /* -fivar-visibility= */
  OPT_fivopts = 1458,                        /* -fivopts */
  OPT_fjump_tables = 1459,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1460,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1461,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1462,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1463,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1464,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1465,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1466,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1467,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1468,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1469,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1470,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1471, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1472,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1473,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1474,            /* -fleading-underscore */
  OPT_flibs_ = 1475,                         /* -flibs= */
  OPT_flifetime_dse = 1476,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1477,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1478,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1479,                /* -flinker-output= */
  /* OPT_flive_patching = 1480, */           /* -flive-patching */
  OPT_flive_patching_ = 1481,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1482,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1483,                   /* -flocal-ivars */
  OPT_flocation_ = 1484,                     /* -flocation= */
  /* OPT_floop_block = 1485, */              /* -floop-block */
  /* OPT_floop_flatten = 1486, */            /* -floop-flatten */
  OPT_floop_interchange = 1487,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1488,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1489, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1490,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1491, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1492,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1493,                     /* -flra-remat */
  OPT_flto = 1494,                           /* -flto */
  OPT_flto_compression_level_ = 1495,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1496,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1497,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1498, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1499,                /* -flto-partition= */
  OPT_flto_report = 1500,                    /* -flto-report */
  OPT_flto_report_wpa = 1501,                /* -flto-report-wpa */
  OPT_flto_ = 1502,                          /* -flto= */
  OPT_fltrans = 1503,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1504,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1505,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1506,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1507,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1508,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1509,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1510,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1511,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1512,                          /* -fm2-g */
  OPT_fm2_lower_case = 1513,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1514,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1515,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1516,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1517,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1518,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1519,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1520,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1521,             /* -fmacro-prefix-map= */
  OPT_fmain = 1522,                          /* -fmain */
  OPT_fmalloc_dce = 1523,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1524,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1525,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1526,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1527,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1528,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1529,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1530,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1531,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1532,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1533,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1534,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1535,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1536,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1537,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1538,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1539,                          /* -fmod= */
  OPT_fmodule_file_ = 1540,                  /* -fmodule-file= */
  OPT_fmodule_header = 1541,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1542,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1543,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1544,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1545,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1546,                   /* -fmodule-only */
  OPT_fmodule_private = 1547,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1548,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1549,                    /* -fmoduleinfo */
  OPT_fmodules = 1550,                       /* -fmodules */
  /* OPT_fmodules_ts = 1551, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1552,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1553,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1554,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1555,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1556,                 /* -fms-extensions */
  OPT_fmudflap = 1557,                       /* -fmudflap */
  OPT_fmudflapir = 1558,                     /* -fmudflapir */
  OPT_fmudflapth = 1559,                     /* -fmudflapth */
  OPT_fmultiflags = 1560,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1561,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1562,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1563,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1564,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1565,                  /* -fnext-runtime */
  OPT_fnil = 1566,                           /* -fnil */
  OPT_fnil_receivers = 1567,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1568,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1569,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1570,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1571,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1572,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1573,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1574,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1575,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1576,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1577,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1578,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1579,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1580,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1581,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1582,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1583,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1584,              /* -foffload-options= */
  OPT_foffload_ = 1585,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1586,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1587,                         /* -fonly= */
  OPT_fopenacc = 1588,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1589,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1590,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1591,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1592,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1593, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1594,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1595,                /* -foperator-names */
  OPT_fopt_info = 1596,                      /* -fopt-info */
  OPT_fopt_info_ = 1597,                     /* -fopt-info- */
  OPT_foptimize_crc = 1598,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1599, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1600,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1601,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1602, */          /* -foptional-diags */
  OPT_fpack_derived = 1603,                  /* -fpack-derived */
  OPT_fpack_struct = 1604,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1605,                  /* -fpack-struct= */
  OPT_fpad_source = 1606,                    /* -fpad-source */
  OPT_fpartial_inlining = 1607,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1608,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1609,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1610,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1611,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1612,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1613,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1614,                    /* -fpeel-loops */
  OPT_fpeephole = 1615,                      /* -fpeephole */
  OPT_fpeephole2 = 1616,                     /* -fpeephole2 */
  OPT_fpermissive = 1617,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1618,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1619,                           /* -fpic */
  OPT_fpie = 1620,                           /* -fpie */
  OPT_fpim = 1621,                           /* -fpim */
  OPT_fpim2 = 1622,                          /* -fpim2 */
  OPT_fpim3 = 1623,                          /* -fpim3 */
  OPT_fpim4 = 1624,                          /* -fpim4 */
  OPT_fplan9_extensions = 1625,              /* -fplan9-extensions */
  OPT_fplt = 1626,                           /* -fplt */
  OPT_fplugin_arg_ = 1627,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1628,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1629,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1630,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1631,                /* -fpostconditions */
  OPT_fpre_include_ = 1632,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1633,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1634,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1635,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1636,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1637,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1638,              /* -fpretty-templates */
  OPT_fpreview_all = 1639,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1640,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1641,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1642,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1643,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1644,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1645,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1646,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1647,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1648,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1649,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1650,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1651,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1652,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1653,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1654,           /* -fprintf-return-value */
  OPT_fprofile = 1655,                       /* -fprofile */
  OPT_fprofile_abs_path = 1656,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1657,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1658,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1659,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1660,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1661,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1662,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1663,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1664,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1665,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1666,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1667,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1668,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1669,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1670,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1671,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1672,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1673,               /* -fprofile-update= */
  OPT_fprofile_use = 1674,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1675,                  /* -fprofile-use= */
  OPT_fprofile_values = 1676,                /* -fprofile-values */
  OPT_fprotect_parens = 1677,                /* -fprotect-parens */
  OPT_fpthread = 1678,                       /* -fpthread */
  OPT_fq = 1679,                             /* -fq */
  OPT_frandom_seed = 1680,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1681,                  /* -frandom-seed= */
  OPT_frange = 1682,                         /* -frange */
  OPT_frange_check = 1683,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1684,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1685,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1686,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1687,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1688,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1689,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1690,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1691,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1692,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1693,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1694,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1695,               /* -frecord-marker=8 */
  OPT_frecursive = 1696,                     /* -frecursive */
  OPT_free = 1697,                           /* -free */
  /* OPT_freg_struct_return = 1698, */       /* -freg-struct-return */
  /* OPT_fregmove = 1699, */                 /* -fregmove */
  OPT_frelease = 1700,                       /* -frelease */
  OPT_frename_registers = 1701,              /* -frename-registers */
  OPT_freorder_blocks = 1702,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1703,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1704,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1705,             /* -freorder-functions */
  OPT_frepack_arrays = 1706,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1707,          /* -freplace-objc-classes */
  OPT_frepo = 1708,                          /* -frepo */
  OPT_freport_bug = 1709,                    /* -freport-bug */
  OPT_frequire_return_statement = 1710,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1711,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1712, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1713,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1714,                   /* -fresolution= */
  OPT_freturn = 1715,                        /* -freturn */
  OPT_frevert_all = 1716,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1717,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1718,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1719,             /* -frevert=intpromote */
  OPT_frounding_math = 1720,                 /* -frounding-math */
  OPT_frtti = 1721,                          /* -frtti */
  OPT_fruntime_modules_ = 1722,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1723,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1724,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1725,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1726,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1727,                   /* -frust-crate= */
  OPT_frust_debug = 1728,                    /* -frust-debug */
  OPT_frust_dump_ = 1729,                    /* -frust-dump- */
  OPT_frust_edition_ = 1730,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1731,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1732,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1733,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1734,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1735,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1736,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1737,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1738,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1739,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1740,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1741,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1742,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1743,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1744,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1745,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1746,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1747, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1748,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1749,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1750,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1751,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1752,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1753,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1754,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1755,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1756, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1757,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1758,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1759,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1760,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1761,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1762,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1763,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1764,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1765,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1766,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1767,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1768,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1769,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1770,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1771,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1772,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1773, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1774,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1775,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1776,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1777,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1778,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1779,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1780,               /* -fsection-anchors */
  /* OPT_fsee = 1781, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1782,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1783,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1784,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1785,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1786,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1787,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1788,        /* -fsemantic-interposition */
  OPT_fshared = 1789,                        /* -fshared */
  OPT_fshort_enums = 1790,                   /* -fshort-enums */
  OPT_fshort_wchar = 1791,                   /* -fshort-wchar */
  OPT_fshow_column = 1792,                   /* -fshow-column */
  OPT_fshrink_wrap = 1793,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1794,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1795,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1796,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1797,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1798,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1799,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1800,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1801,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1802,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1803,                /* -fsoft-check-all */
  OPT_fsources = 1804,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1805,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1806,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1807,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1808,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1809,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1810,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1811,                      /* -fsquangle */
  OPT_fssa_backprop = 1812,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1813,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1814,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1815,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1816, */             /* -fstack-check */
  OPT_fstack_check_ = 1817,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1818,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1819,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1820,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1821,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1822,               /* -fstack-protector */
  OPT_fstack_protector_all = 1823,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1824,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1825,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1826,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1827,                   /* -fstack-usage */
  OPT_fstatic_call = 1828,                   /* -fstatic-call */
  OPT_fstats = 1829,                         /* -fstats */
  OPT_fstdarg_opt = 1830,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1831,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1832, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1833,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1834,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1835, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1836,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1837,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1838,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1839,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1840, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1841,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1842,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1843,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1844,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1845,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1846,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1847,                  /* -fstrub=strict */
  OPT_fswig = 1848,                          /* -fswig */
  OPT_fswitch_errors = 1849,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1850,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1851,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1852,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1853, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1854,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1855, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1856,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1857, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1858,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1859,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1860,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1861,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1862,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1863,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1864,                   /* -ftime-report */
  OPT_ftime_report_details = 1865,           /* -ftime-report-details */
  OPT_ftls_model_ = 1866,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1867,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1868,                   /* -ftrace-debug */
  OPT_ftracer = 1869,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1870,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1871,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1872,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1873,                   /* -ftrampolines */
  OPT_ftransition_all = 1874,                /* -ftransition=all */
  OPT_ftransition_field = 1875,              /* -ftransition=field */
  OPT_ftransition_in = 1876,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1877,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1878,          /* -ftransition=templates */
  OPT_ftransition_tls = 1879,                /* -ftransition=tls */
  OPT_ftrapping_math = 1880,                 /* -ftrapping-math */
  OPT_ftrapv = 1881,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1882,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1883,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1884,                      /* -ftree-ccp */
  OPT_ftree_ch = 1885,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1886, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1887,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1888,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1889, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1890,                   /* -ftree-cselim */
  OPT_ftree_dce = 1891,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1892,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1893,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1894,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1895,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1896, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1897,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1898,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1899, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1900,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1901,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1902, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1903,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1904,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1905,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1906,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1907,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1908,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1909,                      /* -ftree-pre */
  OPT_ftree_pta = 1910,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1911,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1912, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1913,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1914,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1915,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1916,                     /* -ftree-slsr */
  OPT_ftree_sra = 1917,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1918, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1919, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1920,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1921,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1922,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1923, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1924,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1925, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1926,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1927,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1928,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1929,         /* -funconstrained-commons */
  OPT_funderscoring = 1930,                  /* -funderscoring */
  OPT_funit_at_a_time = 1931,                /* -funit-at-a-time */
  OPT_funittest = 1932,                      /* -funittest */
  OPT_funreachable_traps = 1933,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1934,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1935,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1936,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1937, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1938,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1939,                      /* -funsigned */
  OPT_funsigned_bitfields = 1940,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1941,                 /* -funsigned-char */
  OPT_funswitch_loops = 1942,                /* -funswitch-loops */
  OPT_funwind_tables = 1943,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1944,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1945,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1946,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1947,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1948,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1949,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1950,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1951,                     /* -fuse-list= */
  OPT_fvar_tracking = 1952,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1953,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1954,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1955,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1956,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1957, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1958,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1959,                   /* -fverbose-asm */
  /* OPT_fversion = 1960, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1961,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1962,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1963,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1964,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1965,                   /* -fvisibility= */
  OPT_fvpt = 1966,                           /* -fvpt */
  OPT_fvtable_gc = 1967,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1968,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1969,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1970,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1971,                     /* -fvtv-debug */
  OPT_fweak = 1972,                          /* -fweak */
  OPT_fweak_templates = 1973,                /* -fweak-templates */
  OPT_fweb = 1974,                           /* -fweb */
  /* OPT_fwhole_file = 1975, */              /* -fwhole-file */
  OPT_fwhole_program = 1976,                 /* -fwhole-program */
  OPT_fwholediv = 1977,                      /* -fwholediv */
  OPT_fwholevalue = 1978,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1979,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1980,             /* -fworking-directory */
  OPT_fwpa = 1981,                           /* -fwpa */
  OPT_fwpa_ = 1982,                          /* -fwpa= */
  OPT_fwrapv = 1983,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1984,                 /* -fwrapv-pointer */
  OPT_fxref = 1985,                          /* -fxref */
  OPT_fyacc_debug = 1986,                    /* -fyacc-debug */
  /* OPT_fzee = 1987, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1988,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1989,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1990,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1991,                     /* -fzero-link */
  OPT_g = 1992,                              /* -g */
  OPT_gant = 1993,                           /* -gant */
  OPT_gas_loc_support = 1994,                /* -gas-loc-support */
  OPT_gas_locview_support = 1995,            /* -gas-locview-support */
  OPT_gbtf = 1996,                           /* -gbtf */
  OPT_gcodeview = 1997,                      /* -gcodeview */
  OPT_gcoff = 1998,                          /* -gcoff */
  OPT_gcoff1 = 1999,                         /* -gcoff1 */
  OPT_gcoff2 = 2000,                         /* -gcoff2 */
  OPT_gcoff3 = 2001,                         /* -gcoff3 */
  OPT_gcolumn_info = 2002,                   /* -gcolumn-info */
  OPT_gctf = 2003,                           /* -gctf */
  OPT_gdescribe_dies = 2004,                 /* -gdescribe-dies */
  OPT_gdwarf = 2005,                         /* -gdwarf */
  OPT_gdwarf_ = 2006,                        /* -gdwarf- */
  OPT_gdwarf32 = 2007,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2008,                       /* -gdwarf64 */
  OPT_gen_decls = 2009,                      /* -gen-decls */
  OPT_ggdb = 2010,                           /* -ggdb */
  OPT_ggnu_pubnames = 2011,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2012,                   /* -gimple-stats */
  OPT_ginline_points = 2013,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2014, /* -ginternal-reset-location-views */
  OPT_gnat = 2015,                           /* -gnat */
  OPT_gnatO = 2016,                          /* -gnatO */
  OPT_gno_ = 2017,                           /* -gno- */
  OPT_gno_pubnames = 2018,                   /* -gno-pubnames */
  OPT_gprune_btf = 2019,                     /* -gprune-btf */
  OPT_gpubnames = 2020,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2021,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2022,                   /* -gsplit-dwarf */
  OPT_gstabs = 2023,                         /* -gstabs */
  OPT_gstabs_ = 2024,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2025,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2026,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2027,                        /* -gtoggle */
  OPT_gvariable_location_views = 2028,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2029,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2030,                           /* -gvms */
  OPT_gxcoff = 2031,                         /* -gxcoff */
  OPT_gxcoff_ = 2032,                        /* -gxcoff+ */
  OPT_gz = 2033,                             /* -gz */
  OPT_gz_ = 2034,                            /* -gz= */
  OPT_h = 2035,                              /* -h */
  OPT_help = 2036,                           /* -help */
  OPT_idirafter = 2037,                      /* -idirafter */
  OPT_imacros = 2038,                        /* -imacros */
  OPT_imultiarch = 2039,                     /* -imultiarch */
  OPT_imultilib = 2040,                      /* -imultilib */
  OPT_include = 2041,                        /* -include */
  OPT_iplugindir_ = 2042,                    /* -iplugindir= */
  OPT_iprefix = 2043,                        /* -iprefix */
  OPT_iquote = 2044,                         /* -iquote */
  OPT_isysroot = 2045,                       /* -isysroot */
  OPT_isystem = 2046,                        /* -isystem */
  OPT_iwithprefix = 2047,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2048,              /* -iwithprefixbefore */
  OPT_k8 = 2049,                             /* -k8 */
  OPT_l = 2050,                              /* -l */
  OPT_lang_asm = 2051,                       /* -lang-asm */
  OPT_list = 2052,                           /* -list */
  OPT_mabi_ = 2053,                          /* -mabi= */
  OPT_main = 2054,                           /* -main */
  OPT_main_ = 2055,                          /* -main= */
  OPT_march_ = 2056,                         /* -march= */
  OPT_mbig_endian = 2057,                    /* -mbig-endian */
  OPT_mbranch_protection_ = 2058,            /* -mbranch-protection= */
  OPT_mcmodel_ = 2059,                       /* -mcmodel= */
  OPT_mcpu_ = 2060,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 2061,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 2062,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 2063,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 2064,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 2065,             /* -mgeneral-regs-only */
  OPT_mharden_sls_ = 2066,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 2067,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 2068,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 2069,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 2070,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 2071,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 2072,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 2073,               /* -moutline-atomics */
  OPT_moverride_ = 2074,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 2075,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 2076,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 2077, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2078,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2079,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2080,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 2081,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 2082,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2083,                     /* -mtls-size= */
  OPT_mtp_ = 2084,                           /* -mtp= */
  OPT_mtrack_speculation = 2085,             /* -mtrack-speculation */
  OPT_mtune_ = 2086,                         /* -mtune= */
  OPT_mverbose_cost_dump = 2087,             /* -mverbose-cost-dump */
  OPT_n = 2088,                              /* -n */
  OPT_name_sort = 2089,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2090,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2091,              /* -no-integrated-cpp */
  OPT_no_pie = 2092,                         /* -no-pie */
  OPT_nocpp = 2093,                          /* -nocpp */
  OPT_nodefaultlibs = 2094,                  /* -nodefaultlibs */
  OPT_nolibc = 2095,                         /* -nolibc */
  OPT_nomain = 2096,                         /* -nomain */
  OPT_nophoboslib = 2097,                    /* -nophoboslib */
  OPT_nostartfiles = 2098,                   /* -nostartfiles */
  OPT_nostdinc = 2099,                       /* -nostdinc */
  OPT_nostdinc__ = 2100,                     /* -nostdinc++ */
  OPT_nostdlib = 2101,                       /* -nostdlib */
  OPT_nostdlib__ = 2102,                     /* -nostdlib++ */
  OPT_o = 2103,                              /* -o */
  OPT_objects = 2104,                        /* -objects */
  OPT_p = 2105,                              /* -p */
  OPT_pass_exit_codes = 2106,                /* -pass-exit-codes */
  /* OPT_pedantic = 2107, */                 /* -pedantic */
  OPT_pedantic_errors = 2108,                /* -pedantic-errors */
  OPT_pg = 2109,                             /* -pg */
  OPT_pie = 2110,                            /* -pie */
  OPT_pipe = 2111,                           /* -pipe */
  OPT_preprocess = 2112,                     /* -preprocess */
  OPT_print_file_name_ = 2113,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2114,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2115,          /* -print-multi-directory */
  OPT_print_multi_lib = 2116,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2117,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2118,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2119,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2120,               /* -print-prog-name= */
  OPT_print_search_dirs = 2121,              /* -print-search-dirs */
  OPT_print_sysroot = 2122,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2123,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2124,                    /* -print-value */
  OPT_quiet = 2125,                          /* -quiet */
  OPT_r = 2126,                              /* -r */
  OPT_remap = 2127,                          /* -remap */
  OPT_reverse_sort = 2128,                   /* -reverse-sort */
  OPT_s = 2129,                              /* -s */
  OPT_save_temps = 2130,                     /* -save-temps */
  OPT_save_temps_ = 2131,                    /* -save-temps= */
  OPT_shared = 2132,                         /* -shared */
  OPT_shared_libgcc = 2133,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2134,               /* -shared-libphobos */
  OPT_size_sort = 2135,                      /* -size-sort */
  /* OPT_specs = 2136, */                    /* -specs */
  OPT_specs_ = 2137,                         /* -specs= */
  OPT_static = 2138,                         /* -static */
  OPT_static_libasan = 2139,                 /* -static-libasan */
  OPT_static_libgcc = 2140,                  /* -static-libgcc */
  OPT_static_libgcobol = 2141,               /* -static-libgcobol */
  OPT_static_libgfortran = 2142,             /* -static-libgfortran */
  OPT_static_libgm2 = 2143,                  /* -static-libgm2 */
  OPT_static_libgo = 2144,                   /* -static-libgo */
  OPT_static_libhwasan = 2145,               /* -static-libhwasan */
  OPT_static_liblsan = 2146,                 /* -static-liblsan */
  OPT_static_libmpx = 2147,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2148,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2149,               /* -static-libphobos */
  OPT_static_libquadmath = 2150,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2151,               /* -static-libstdc++ */
  OPT_static_libtsan = 2152,                 /* -static-libtsan */
  OPT_static_libubsan = 2153,                /* -static-libubsan */
  OPT_static_pie = 2154,                     /* -static-pie */
  /* OPT_std_c__03 = 2155, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2156, */                /* -std=c++0x */
  OPT_std_c__11 = 2157,                      /* -std=c++11 */
  OPT_std_c__14 = 2158,                      /* -std=c++14 */
  OPT_std_c__17 = 2159,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2160, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2161, */                /* -std=c++1z */
  OPT_std_c__20 = 2162,                      /* -std=c++20 */
  OPT_std_c__23 = 2163,                      /* -std=c++23 */
  OPT_std_c__26 = 2164,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2165, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2166, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2167, */                /* -std=c++2c */
  OPT_std_c__98 = 2168,                      /* -std=c++98 */
  OPT_std_c11 = 2169,                        /* -std=c11 */
  OPT_std_c17 = 2170,                        /* -std=c17 */
  /* OPT_std_c18 = 2171, */                  /* -std=c18 */
  /* OPT_std_c1x = 2172, */                  /* -std=c1x */
  OPT_std_c23 = 2173,                        /* -std=c23 */
  /* OPT_std_c2x = 2174, */                  /* -std=c2x */
  OPT_std_c2y = 2175,                        /* -std=c2y */
  /* OPT_std_c89 = 2176, */                  /* -std=c89 */
  OPT_std_c90 = 2177,                        /* -std=c90 */
  OPT_std_c99 = 2178,                        /* -std=c99 */
  /* OPT_std_c9x = 2179, */                  /* -std=c9x */
  OPT_std_f2003 = 2180,                      /* -std=f2003 */
  OPT_std_f2008 = 2181,                      /* -std=f2008 */
  OPT_std_f2008ts = 2182,                    /* -std=f2008ts */
  OPT_std_f2018 = 2183,                      /* -std=f2018 */
  OPT_std_f2023 = 2184,                      /* -std=f2023 */
  OPT_std_f202y = 2185,                      /* -std=f202y */
  OPT_std_f95 = 2186,                        /* -std=f95 */
  OPT_std_gnu = 2187,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2188, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2189, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2190,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2191,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2192,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2193, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2194, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2195,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2196,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2197,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2198, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2199, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2200, */              /* -std=gnu++2c */
  ...
  OPT_std_gnu23 = 2206,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2207, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2208,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2209, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2210,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2211,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2212, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2213, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2214,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2215, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2216, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2217, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2218, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2219, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2220, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2221,                     /* -std=legacy */
  OPT_stdlib_ = 2222,                        /* -stdlib= */
  OPT_symbol_ = 2223,                        /* -symbol= */
  OPT_symbolic = 2224,                       /* -symbolic */
  OPT_t = 2225,                              /* -t */
  OPT_time = 2226,                           /* -time */
  OPT_time_ = 2227,                          /* -time= */
  OPT_traditional = 2228,                    /* -traditional */
  OPT_traditional_cpp = 2229,                /* -traditional-cpp */
  OPT_tree_stats = 2230,                     /* -tree-stats */
  OPT_trigraphs = 2231,                      /* -trigraphs */
  OPT_truncate = 2232,                       /* -truncate */
  OPT_type_stats = 2233,                     /* -type-stats */
  OPT_u = 2234,                              /* -u */
  OPT_undef = 2235,                          /* -undef */
  OPT_v = 2236,                              /* -v */
  OPT_version = 2237,                        /* -version */
  OPT_w = 2238,                              /* -w */
  OPT_wrapper = 2239,                        /* -wrapper */
  OPT_x = 2240,                              /* -x */
  OPT_z = 2241,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
