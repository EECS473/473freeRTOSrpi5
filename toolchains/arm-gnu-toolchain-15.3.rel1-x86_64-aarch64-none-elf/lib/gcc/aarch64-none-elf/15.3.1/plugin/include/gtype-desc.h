...
#define gt_ggc_m_38hash_table_registered_function_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_table_registered_function_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_registered_function_hasher_ (void *);
...
#define gt_pch_n_38hash_table_registered_function_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_table_registered_function_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_registered_function_hasher_ (void *);
...
extern void gt_pch_p_31vec_registered_function__va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_38hash_table_registered_function_hasher_
    (void *, void *, gt_pointer_operator, void *);
