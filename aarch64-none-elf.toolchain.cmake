...
set(TOOLCHAIN_PATH ${CMAKE_SOURCE_DIR}/aarch64-none-elf CACHE PATH "")
...
set(CMAKE_C_FLAGS "-march=armv8-a -mtune=cortex-a76 -nostdlib -ffreestanding -Wall -Wextra" CACHE STRING "C flags")
